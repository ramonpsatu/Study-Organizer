...
class TuesdayListAdapter(
    private val itemClick: (Int) -> Unit,
    private val viewModel: SubjectListViewModel
) : RecyclerView.Adapter<TuesdayListAdapter.ViewHolder>() {
    ...
    fun updateSubjectTuesday(tuesdayList: List<SubjectItem>) {
    ...
    inner class ViewHolder(
        ...
        fun bind(subject: SubjectItem) {
            ...
            viewModel.viewModelScope.launch {
                ...
                val date = android.text.format.DateFormat.format("yyyyMMdd",viewModel.stateOnceDates().value!!.datesOfWeek[1]).toString()
