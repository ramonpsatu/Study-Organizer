...
class MondayListAdapter @Inject constructor(
    private val itemClick: (Int) -> Unit,
    private val viewModel: SubjectListViewModel
) : RecyclerView.Adapter<MondayListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = SubjectShowInCalendarLayoutBinding.inflate(layoutInflater, parent, false)
    ...
    fun updateSubjectMonday(mondayList: List<SubjectItem>) {

        asyncListDiffer.submitList(mondayList)
    }
    ...
    inner class ViewHolder(
        ...
        fun bind(subject: SubjectItem) {
            ...
            viewModel.viewModelScope.launch {
                ...
                val date = android.text.format.DateFormat.format("yyyyMMdd",viewModel.stateOnceDates().value!!.datesOfWeek[0]).toString()
