...
class SaturdayListAdapter(
    private val itemClick: (Int) -> Unit,
    private val viewModel: SubjectListViewModel
) : RecyclerView.Adapter<SaturdayListAdapter.ViewHolder>() {
    ...
    fun updateSubjectSaturday(saturdayList: List<SubjectItem>) {

        asyncListDiffer.submitList(saturdayList)
    }
    ...
    inner class ViewHolder(
        ...
        fun bind(subject: SubjectItem) {
            ...
            viewModel.viewModelScope.launch {
                ...
                val date = android.text.format.DateFormat.format("yyyyMMdd",viewModel.stateOnceDates().value!!.datesOfWeek[5]).toString()
