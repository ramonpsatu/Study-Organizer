...
class SundayListAdapter(
    private val itemClick: (Int) -> Unit,
    private val viewModel: SubjectListViewModel
) : RecyclerView.Adapter<SundayListAdapter.ViewHolder>() {
    ...
    fun updateSubjectSunday(sundayList: List<SubjectItem>) {

        asyncListDiffer.submitList(sundayList)
    }
    ...
    inner class ViewHolder(
        ...
        fun bind(subject: SubjectItem) {
            ...
            viewModel.viewModelScope.launch {
                ...
                val date = android.text.format.DateFormat.format("yyyyMMdd",viewModel.stateOnceDates().value!!.datesOfWeek[6]).toString()
