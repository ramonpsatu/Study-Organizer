...
class WednesdayListAdapter(
    private val itemClick: (Int) -> Unit,
    private val viewModel: SubjectListViewModel
) : RecyclerView.Adapter<WednesdayListAdapter.ViewHolder>() {
    ...
    fun updateSubjectWednesday(tuesdayList: List<SubjectItem>) {

        asyncListDiffer.submitList(tuesdayList)
    }
    ...
    inner class ViewHolder(
        ...
        fun bind(subject: SubjectItem) {
            ...
            viewModel.viewModelScope.launch {
                ...
                val date = android.text.format.DateFormat.format("yyyyMMdd",viewModel.stateOnceDates().value!!.datesOfWeek[2]).toString()
